      ...
      >
        ...
        <el-form-item label="选择文件">
          <el-upload
            class="upload-demo"
            ref="upload"
            action="http://yjyback.sdtyyjy.cn/api/test/upload"
        ...
        <el-form-item label="资源类型">
          <el-dropdown>
            <el-button type="primary">
              类型<i class="el-icon-arrow-down el-icon--right" />
            </el-button>
            <el-dropdown-menu slot="dropdown">
              <el-dropdown-item @click="setType('类型', 2)"
                >类型</el-dropdown-item
              >
              <el-dropdown-item @click="setType('教案', 1)"
                >教案</el-dropdown-item
        ...
        <el-form-item label="学段">
          <el-dropdown>
            <el-button type="primary">
              学段<i class="el-icon-arrow-down el-icon--right" />
            </el-button>
            <el-dropdown-menu slot="dropdown">
              <el-dropdown-item @click="setType('课件', 2)"
                >课件</el-dropdown-item
        ...
        <el-form-item label="科目">
          <el-dropdown>
            <el-button type="primary">
              科目<i class="el-icon-arrow-down el-icon--right" />
            </el-button>
            <el-dropdown-menu slot="dropdown">
              <el-dropdown-item @click="setType('课件', 2)"
                >课件</el-dropdown-item
        ...
        <el-form-item label="版本">
          <el-dropdown>
            <el-button type="primary">
              版本<i class="el-icon-arrow-down el-icon--right" />
            </el-button>
            <el-dropdown-menu slot="dropdown">
              <el-dropdown-item @click="setType('课件', 2)"
                >课件</el-dropdown-item
        ...
        <el-form-item label="分册">
          <el-dropdown>
            <el-button type="primary">
              分册<i class="el-icon-arrow-down el-icon--right" />
            </el-button>
            <el-dropdown-menu slot="dropdown">
              <el-dropdown-item @click="setType('课件', 2)"
                >课件</el-dropdown-item
