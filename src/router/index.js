    ...
    children: [
      {
        ...
        name: "Dashboard",
        meta: { title: "dashboard", icon: "el-icon-s-help", affix: true }
      }
    ]
  },
...
export const asyncRoutes = [
  ...
  //资源管理
  {
    ...
    children: [
      {
        path: "resourceManagement",
        component: () => import("@/views/resourceManagement/resourceManagement"),
  ...
  // 审核管理
  {
    ...
    children: [
      {
        path: "auditManagement",
        component: () => import("@/views/auditManagement/auditManagement"),
  ...
  //系统设置
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: () => import("@/views/systemManagement/dictionaryManagement"),
